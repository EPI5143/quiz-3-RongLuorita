#Name:Rong Luo  Student ID:300099510
...
nrow(mpg)
dim(mpg)
###Results: This dataset has 234 observations and 11 variables; 
...
ggplot(data=mpg,aes(x=displ,y=hwy,color=class,shape=drv,size=cyl))+geom_point()
...
ggplot(data=mpg,aes(x=displ,y=hwy,color=class,shape=drv,size=cyl))+geom_point()+
ggtitle("Comparing highway fuel efficiency among vehicles with different engine size")
